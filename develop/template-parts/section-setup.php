...
$set_times_to_show = get_sub_field('set_times_to_show') ?: '';

if($set_times_to_show) {
...
<section id="<?php echo $section_css_id; ?>" style="<?php echo $bg_style; ?>" class="<?php echo $hideSection; ?>">
