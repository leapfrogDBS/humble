...
$row_classes = 'row grid grid-cols-1 max-w-[1500px] mx-auto ';
    ...
    <div class="w-full p-0 mx-auto">
        <div <?php echo $css_id; ?> class="row <?php echo $row_classes; ?>" style="<?php echo $row_style; ?>">
            ...
            <div class="bg-image-col image-col col bg-no-repeat bg-cover h-auto <?php echo $col2_class; ?>">
                <img class ="h-full w-full object-cover max-h-[600px] lg:max-h-none" style="<?php echo $style_position; ?>" src="<?php echo $column_two_image['url']; ?>" alt="<?php echo $column_two_image['alt']; ?>">
            </div>
        </div>
    </div>
</section>